...
export function AccountPage() {
  ...
  return (
    <main className="account-page container" aria-labelledby="account-page-title">
      <header className="account-page__header app-page-heading--title-only">
            ...
            <div className="account-page__panel">
              <div className="account-page__row">
                ...
                <div className="account-page__row-actions">
                  <Badge variant={maintenance.enabled ? "amber" : "default"} aria-live="polite">
                    {maintenanceLabel}
                  </Badge>
                  <button
                    type="button"
